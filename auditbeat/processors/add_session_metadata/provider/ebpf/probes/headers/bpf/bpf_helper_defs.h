...
static long (*bpf_skb_store_bytes)(
    struct __sk_buff *skb, __u32 offset, const void *from, __u32 len, __u64 flags) = (void *) 9;
...
static long (*bpf_l3_csum_replace)(
    struct __sk_buff *skb, __u32 offset, __u64 from, __u64 to, __u64 size) = (void *) 10;
...
static long (*bpf_l4_csum_replace)(
    struct __sk_buff *skb, __u32 offset, __u64 from, __u64 to, __u64 flags) = (void *) 11;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_vlan_push)(struct __sk_buff *skb,
                                 __be16 vlan_proto,
...
static __s64 (*bpf_csum_diff)(
    __be32 *from, __u32 from_size, __be32 *to, __u32 to_size, __wsum seed) = (void *) 28;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_setsockopt)(void *bpf_socket, int level, int optname, void *optval, int optlen) =
    (void *) 49;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_adjust_room)(struct __sk_buff *skb,
                                   __s32 len_diff,
                                   __u32 mode,
                                   __u64 flags) = (void *) 50;
 ...
 */
static long (*bpf_sk_redirect_map)(struct __sk_buff *skb,
                                   void *map,
                                   __u32 key,
                                   __u64 flags) = (void *) 52;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_sock_map_update)(struct bpf_sock_ops *skops,
                                   void *map,
                                   void *key,
                                   __u64 flags) = (void *) 53;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_perf_event_read_value)(void *map,
                                         __u64 flags,
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_getsockopt)(void *bpf_socket, int level, int optname, void *optval, int optlen) =
    (void *) 57;
 ...
 * 	**SK_PASS** on success, or **SK_DROP** on error.
 */
static long (*bpf_msg_redirect_map)(struct sk_msg_md *msg,
                                    void *map,
                                    __u32 key,
                                    __u64 flags) = (void *) 60;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_msg_pull_data)(struct sk_msg_md *msg,
                                 __u32 start,
                                 __u32 end,
                                 __u64 flags) = (void *) 63;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_bind)(struct bpf_sock_addr *ctx,
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_get_xfrm_state)(struct __sk_buff *skb,
                                      __u32 index,
...
static long (*bpf_skb_load_bytes_relative)(
    const void *skb, __u32 offset, void *to, __u32 len, __u32 start_header) = (void *) 68;
 ...
 */
static long (*bpf_fib_lookup)(void *ctx,
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_sock_hash_update)(struct bpf_sock_ops *skops,
                                    void *map,
                                    void *key,
                                    __u64 flags) = (void *) 70;
 ...
 * 	**SK_PASS** on success, or **SK_DROP** on error.
 */
static long (*bpf_msg_redirect_hash)(struct sk_msg_md *msg,
                                     void *map,
                                     void *key,
                                     __u64 flags) = (void *) 71;
 ...
 * 	**SK_PASS** on success, or **SK_DROP** on error.
 */
static long (*bpf_sk_redirect_hash)(struct __sk_buff *skb,
                                    void *map,
                                    void *key,
                                    __u64 flags) = (void *) 72;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_lwt_push_encap)(struct __sk_buff *skb,
                                  __u32 type,
                                  void *hdr,
                                  __u32 len) = (void *) 73;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_lwt_seg6_store_bytes)(struct __sk_buff *skb,
                                        __u32 offset,
                                        const void *from,
                                        __u32 len) = (void *) 74;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_lwt_seg6_adjust_srh)(struct __sk_buff *skb,
                                       __u32 offset,
                                       __s32 delta) = (void *) 75;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_lwt_seg6_action)(struct __sk_buff *skb,
                                   __u32 action,
                                   void *param,
 ...
 * 	0
 */
static long (*bpf_rc_keydown)(void *ctx,
                              __u32 protocol,
                              __u64 scancode,
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_sk_select_reuseport)(struct sk_reuseport_md *reuse,
                                       void *map,
                                       void *key,
                                       __u64 flags) = (void *) 82;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_msg_push_data)(struct sk_msg_md *msg,
                                 __u32 start,
                                 __u32 len,
                                 __u64 flags) = (void *) 90;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_msg_pop_data)(struct sk_msg_md *msg,
                                __u32 start,
                                __u32 len,
                                __u64 flags) = (void *) 91;
...
static long (*bpf_tcp_check_syncookie)(
    void *sk, void *iph, __u32 iph_len, struct tcphdr *th, __u32 th_len) = (void *) 100;
 ...
 */
static long (*bpf_sysctl_get_name)(struct bpf_sysctl *ctx,
                                   char *buf,
 ...
 */
static long (*bpf_sysctl_get_current_value)(struct bpf_sysctl *ctx,
                                            char *buf,
                                            unsigned long buf_len) = (void *) 102;
 ...
 */
static long (*bpf_sysctl_get_new_value)(struct bpf_sysctl *ctx,
                                        char *buf,
 ...
 */
static long (*bpf_strtol)(const char *buf,
                          unsigned long buf_len,
                          __u64 flags,
                          long *res) = (void *) 105;
 ...
 * 	**-ERANGE** if resulting value was out of range.
 */
static long (*bpf_strtoul)(const char *buf,
                           unsigned long buf_len,
                           __u64 flags,
...
static __s64 (*bpf_tcp_gen_syncookie)(
    void *sk, void *iph, __u32 iph_len, struct tcphdr *th, __u32 th_len) = (void *) 110;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_skb_output)(void *ctx, void *map, __u64 flags, void *data, __u64 size) =
    (void *) 111;
 ...
 */
static long (*bpf_get_ns_current_pid_tgid)(__u64 dev,
                                           __u64 ino,
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_output)(void *ctx, void *map, __u64 flags, void *data, __u64 size) =
    (void *) 121;
 ...
 * 	*size* on success, or a negative error in case of failure.
 */
static long (*bpf_get_task_stack)(struct task_struct *task,
                                  void *buf,
                                  __u32 size,
 ...
 * 	*skops*\ **->op**.
 */
static long (*bpf_load_hdr_opt)(struct bpf_sock_ops *skops,
                                void *searchby_res,
                                __u32 len,
 ...
 * 	*skops*\ **->op**.
 */
static long (*bpf_reserve_hdr_opt)(struct bpf_sock_ops *skops,
                                   __u32 len,
 ...
 */
static void *(*bpf_inode_storage_get)(void *map,
                                      void *inode,
                                      void *value,
...
static long (*bpf_snprintf_btf)(
    char *str, __u32 str_size, struct btf_ptr *ptr, __u32 btf_ptr_size, __u64 flags) = (void *) 149;
 ...
 * 	0 on success or a negative error in case of failure.
 */
static long (*bpf_seq_printf_btf)(struct seq_file *m,
                                  struct btf_ptr *ptr,
                                  __u32 ptr_size,
 ...
 */
static long (*bpf_redirect_neigh)(__u32 ifindex,
 ...
 * 	a new bpf_local_storage.
 */
static void *(*bpf_task_storage_get)(void *map,
 ...
 */
static long (*bpf_check_mtu)(
    void *ctx, __u32 ifindex, __u32 *mtu_len, __s32 len_diff, __u64 flags) = (void *) 163;
 ...
 */
static long (*bpf_snprintf)(
    char *str, __u32 str_size, const char *fmt, __u64 *data, __u32 data_len) = (void *) 165;
 ...
 */
static long (*bpf_btf_find_by_name_kind)(char *name,
                                         int name_sz,
                                         __u32 kind,
                                         int flags) = (void *) 167;
 ...
 * 	in case of failure.
 */
static long (*bpf_trace_vprintk)(const char *fmt,
                                 __u32 fmt_size,
                                 const void *data,
 ...
 */
static long (*bpf_kallsyms_lookup_name)(const char *name,
                                        int name_sz,
                                        int flags,
                                        __u64 *res) = (void *) 179;
 ...
 *
 * 	long (\*callback_fn)(struct task_struct \*task, struct vm_area_struct \*vma, void
 * \*callback_ctx);
 *
 *
 * Returns
 ...
 */
static long (*bpf_find_vma)(struct task_struct *task,
                            __u64 addr,
                            void *callback_fn,
                            void *callback_ctx,
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_load_bytes)(struct xdp_md *xdp_md,
                                  __u32 offset,
                                  void *buf,
                                  __u32 len) = (void *) 189;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_store_bytes)(struct xdp_md *xdp_md,
                                   __u32 offset,
                                   void *buf,
                                   __u32 len) = (void *) 190;
 ...
 */
static long (*bpf_copy_from_user_task)(void *dst,
                                       __u32 size,
                                       const void *user_ptr,
 ...
 */
static long (*bpf_skb_set_tstamp)(struct __sk_buff *skb,
                                  __u64 tstamp,
 ...
 */
static long (*bpf_dynptr_from_mem)(void *data,
                                   __u32 size,
                                   __u64 flags,
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_ringbuf_reserve_dynptr)(void *ringbuf,
                                          __u32 size,
                                          __u64 flags,
 ...
 * 	*flags* is not 0.
 */
static long (*bpf_dynptr_read)(
    void *dst, __u32 len, const struct bpf_dynptr *src, __u32 offset, __u64 flags) = (void *) 201;
 ...
 */
static long (*bpf_dynptr_write)(
    const struct bpf_dynptr *dst, __u32 offset, void *src, __u32 len, __u64 flags) = (void *) 202;
 ...
 * 	is out of bounds.
 */
static void *(*bpf_dynptr_data)(const struct bpf_dynptr *ptr,
                                __u32 offset,
                                __u32 len) = (void *) 203;
 ...
 */
static long (*bpf_tcp_raw_check_syncookie_ipv4)(struct iphdr *iph,
                                                struct tcphdr *th) = (void *) 206;
 ...
 * 	**-EPROTONOSUPPORT** if CONFIG_IPV6 is not builtin.
 */
static long (*bpf_tcp_raw_check_syncookie_ipv6)(struct ipv6hdr *iph,
                                                struct tcphdr *th) = (void *) 207;
 ...
 */
static long (*bpf_user_ringbuf_drain)(void *map,
                                      void *callback_fn,
                                      void *ctx,
 ...
 * 	a new bpf_local_storage.
 */
static void *(*bpf_cgrp_storage_get)(void *map,
